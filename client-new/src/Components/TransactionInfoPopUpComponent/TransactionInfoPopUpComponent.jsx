...
import * as styled from './TransactionInfoPopUpComponent.style';
...
function TransactionInfoPopUpComponent({ close }) {
   const selectedTransaction = useSelector(selectedTransactionSelector);
   const selectedTransactionLoading = useSelector(
      selectedTransactionLoadingSelector
   );
   const selectedTransactionError = useSelector(
      selectedTransactionErrorSelector
   );
         ...
         >
            ...
            <styled.statusDiv className="mt-4">
               {selectedTransactionError && (
                  <p className="text-sm error_cl">{selectedTransactionError}</p>
               )}
               {selectedTransactionLoading && <SpennerComponent />}
               {!!selectedTransaction &&
...
export default TransactionInfoPopUpComponent;
